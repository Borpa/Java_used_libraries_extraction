...
def calculate_libraries(soft_list, full_list):
    ...
    for software in soft_list:
        ...
        for comparison in full_list:
            ...
            #if file1_type != file2_type and same_imports_perc < 70: continue
            #if file1_type == file2_type and same_imports_perc > 30 or same_uniques_perc > 35: continue
            #if file1_type == file2_type and same_imports_perc > 30: continue
...
def main():
    ...
    #with Pool() as pool:
    #    L = pool.starmap(calculate_libraries, [(1, 1), (2, 1), (3, 1)])
    #    M = pool.starmap(calculate_libraries, zip(a_args, repeat(second_arg)))
    #    N = pool.map(partial(calculate_libraries, b=second_arg), a_args)
    #    assert L == M == N
